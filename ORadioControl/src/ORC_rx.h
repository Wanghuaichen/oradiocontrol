...
{
  uint8_t   failSafeMode;           // 1 failSafePos nach Zeit, 0 = off (für Regler)
  uint8_t   failSafeDelay[8];       // Zeit bis failsafepos anspricht in 25ms Steps (255 = hold)
...
typedef struct t_OutputData
{
  ...
  uint8_t   timer[8];             // ms seit letzter Ausgabe
